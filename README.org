...
This package provides access to a local copy of the [[https://emacsmirror.org][Emacsmirror]]
...
For more information see the [[https://docs.emacsmirror.org/epkg][manual]] and the [[https://emacsmirror.org][Emacsmirror]].
...
#+html: <a href="https://snapshots.melpa.org/#/epkg"><img alt="MELPA Snapshots" src="https://snapshots.melpa.org/packages/epkg-badge.svg"/></a>
#+html: <a href="https://releases.melpa.org/#/epkg"><img alt="MELPA Releases" src="https://releases.melpa.org/packages/epkg-badge.svg"/></a>
